...
if __name__ == "__main__":
    ...
    server = MCPVinmecServer("vinmec-medical-mcp-server")
    ...
    test_result = server.call_tool("doctor_schedule_query", {"specialty": "Tim mạch", "facility": "Vinmec Times City", "date": "15/09/2026"})
    if not test_result:
